...
function shareText(score) {
    ...
    SubmitResults();
    if (score <= 30) return 'Average Howard';
    if (score <= 60) return 'Super Howard';
    if (score <= 100) return 'Mayumiiiiiii';
    return 'Are you Howard himself?';
}
